...
import ExpresImg from '../images/express.svg'
  ...
  return (
    <section id="skills" className="mb-16">
      ...
      <div className="flex justify-between">
        ...
        <div className=" border-solid border border-black-900 h-28 p-2 sm:p-0 sm:h-44 w-1/4 sm:w-1/5 flex justify-center items-center rounded-md bg-white">
          <div>
            <img  src={ExpresImg} alt="html" className="sm:pl-4 expressimg" />
            <p className="font-mono text-xs sm:text-base">EXPRESS JS</p>
          </div>
        </div>
        <div className=" border-solid border border-black-900 h-28 p-2 sm:p-0 sm:h-44 w-1/4 sm:w-1/5 flex justify-center items-center rounded-md bg-white">
          <div>
